...
object SparkTweets {
  ...
  def main(args: Array[String]) {
    ...
    //Load the Tweets
    val tweet_file   = Paths.get("test/sandy_keyword_geo_tweet_sample.json").toAbsolutePath.normalize
  ...
  private def filterOnTimeExample(tweets: Array[FullTweet])={
  ...
  private def filterGeoTweetsExample(tweets: Array[FullTweet])={
